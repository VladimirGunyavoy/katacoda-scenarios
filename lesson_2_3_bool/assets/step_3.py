...
Создайте переменную warm_clothes, равную сумме переменных rain и wind. Выведите текст "Теплая одежда: x", где вместо x будет значение переменной warm_clothes.
